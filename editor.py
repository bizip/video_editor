...
st.title('Convert you video into animated gif')

## Upload file ##
st.sidebar.header('Upload you video')
uploaded_file = st.sidebar.file_uploader("Choose a video", type=['mov', 'mp4'])
st.sidebar.markdown('''
    Remember to edit before generating
''')
